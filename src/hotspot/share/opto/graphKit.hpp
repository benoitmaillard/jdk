...
class GraphKit : public Phase {
 ...
 public:
  ...
  Node* make_debug_print(const char* str, NN... in) {
    ...
    Node* call = make_runtime_call(flags, OptoRuntime::debug_print_Type() /* TODO we need to make the type dynamically */, call_addr, "debug_print", TypeRawPtr::BOTTOM, str_node, in...);
